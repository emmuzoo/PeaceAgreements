...
| python <ul><li>2019_PRAC_2.ipynb</il><li>dataset <ul><li>cleaning_full.csv</il></ul></il><li>cleaning_full.csv</il></ul> | Directorio del proyecto en python <ul><li>Fichero de Jupyter Notebook</il><li>Directorio del dataset</il><li>Directorio del dataset</il></ul>||
